...
class FuzzySuggestion:
  ...
  def _metadata( self, suggestion ):
    ...
    highlight = "<span>" + suggestion[0] + "</span>\n" + self._token_string( suggestion[1] ) + " <span size='small' foreground='#999999'>modified " + time_string + "</span>"
  ...
  def _token_string( self, file ):
    ...
    if token != '':
      ...
      token = '.'
    return "<span size='small' foreground='#999999'><b>" + token.upper() + '</b></span> '
